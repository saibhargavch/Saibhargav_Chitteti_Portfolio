...
export function HeroSection() {
  ...
  const userTagline = "Aspiring and Network engineer with hands-on experience in SIEM Tools, VAPT. Adept at using tools like Burp Suite,Nmap,Looking for opportunities to apply my skills as a fresher and learn new technologies.";
